  ...
  return (
    <nav className="w-full flex items-center justify-between px-4 py-2 bg-blue-700 text-white rounded mb-6 shadow">
      <div className="font-bold text-lg tracking-wide">
        ⚡ Industrial IoT Platform - Motor Engine Sensor Dashboard
      </div>
      <div className="flex gap-4 text-sm">
        ...
        <a
          href="https://github.com/arnobt78/Embedded-Motor-Engine-Speed-Temperature-Measurement--CPP-DotNet-React"
          className="hover:underline"
          target="_blank"
          rel="noopener noreferrer"
        >
