...
export default function NotificationSidebar({ message, highestTemp, lowestTemp, highestRpm, lowestRpm }: Props) {
  return (
    <div className="fixed right-0 top-1/3 w-72 space-y-4">
      {message && (
      ...
      {highestTemp && (
        <div className="p-4 bg-white text-red-700 border-l-8 border-red-400 rounded-l-lg shadow flex items-center bg-red-100">
          <span className="mr-2 text-xl">⚠️</span>
          <div>
            <div className="font-bold">Highest Temp: {highestTemp.temperature}°C</div>
      ...
      {lowestTemp && (
        <div className="p-4 bg-green-100 text-green-900 border-l-8 border-green-400 rounded-l-lg shadow flex items-center">
          <span className="mr-2 text-xl">⚠️</span>
          <div>
            <div className="font-bold">Lowest Temp: {lowestTemp.temperature}°C</div>
            <div className="text-xs text-gray-500">{
              (() => {
      ...
      {highestRpm && (
        <div className="p-4 bg-orange-100 text-orange-900 border-l-8 border-orange-400 rounded-l-lg shadow flex items-center">
          ...
          <div>
            <div className="font-bold">Highest Rotation (RPM): {highestRpm.speed}</div>
            <div className="text-xs text-gray-500">{
              (() => {
      ...
      {lowestRpm && (
        <div className="p-4 bg-blue-100 text-blue-900 border-l-8 border-blue-400 rounded-l-lg shadow flex items-center">
          <FaCog className="mr-2 text-xl" />
          <div>
            <div className="font-bold">Lowest Rotation (RPM): {lowestRpm.speed}</div>
            <div className="text-xs text-gray-500">{
              (() => {
